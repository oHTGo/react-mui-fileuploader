    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Paper, __assign({ sx: { p: 1 }, elevation: 0, ref: filesCardRef, variant: "outlined" }, containerCompatibilityProps),
            React.createElement(Typography, { gutterBottom: true, component: "div", color: "textSecondary", sx: { display: 'flex' } },
                ...
                (files === null || files === void 0 ? void 0 : files.length) > 0 && (React.createElement(Box, { sx: { fontSize: 12 } },
                    files.length,
            ...
            React.createElement(Paper, __assign({ elevation: 0, sx: { p: 1, transition: 500, background: background } }, bannerCompatibilityProps),
                React.createElement(Grid, { container: true, spacing: 2, alignItems: "center", justifyContent: "center" },
                    showPlaceholderImage && (React.createElement(Grid, __assign({ item: true, xs: 12, sm: 3, md: 4, sx: { textAlign: 'center', mt: { xs: -3, sm: 2 } } }, PlaceholderGridProps),
                    ...
                    React.createElement(Grid, __assign({ item: true, xs: 12, sm: true, md: true, sx: {
                        ...
                        React.createElement(Typography, { variant: "caption" },
                            leftLabel,
                            React.createElement(Button, { size: "small", color: "secondary", variant: "outlined", onClick: function () {
                                    var _a;
                                    if (disabled)
                                        return;
            ...
            error && (React.createElement(Alert, { color: "error", severity: "error", sx: { mt: 1 }, onClose: function () { return setError(null); } }, error)),
            (files === null || files === void 0 ? void 0 : files.length) > 0 && (React.createElement(React.Fragment, null,
                ...
                React.createElement(Typography, { component: "div", align: "right", sx: { mt: 1 } },
                    React.createElement(Button, { size: "small", onClick: removeFile, ref: buttonDeleteRef }, buttonRemoveLabel || 'Remove all')))))));
}
