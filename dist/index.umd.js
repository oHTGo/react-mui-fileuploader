(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function FileUpload(props) {
                ...
                try {
                    var _loop_1 = function (i) {
                        ...
                        if (allowedExtensions && allowedExtensions.length > 0) {
                            var isAllowed = allowedExtensions.findIndex(function (ext) { return ext.toLowerCase() === extension.toLowerCase(); }) !== -1;
                            if (!isAllowed) {
        ...
        React.useEffect(function () {
            if (defaultFiles && defaultFiles.length > 0 && files.length !== defaultFiles.length) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(material.Paper, __assign({ sx: { p: 1 }, elevation: 0, ref: filesCardRef, variant: "outlined" }, containerCompatibilityProps),
                React.createElement(material.Typography, { gutterBottom: true, component: "div", color: "textSecondary", sx: { display: 'flex' } },
                    ...
                    (files === null || files === void 0 ? void 0 : files.length) > 0 && (React.createElement(material.Box, { sx: { fontSize: 12 } },
                        files.length,
                ...
                React.createElement(material.Paper, __assign({ elevation: 0, sx: { p: 1, transition: 500, background: background } }, bannerCompatibilityProps),
                    React.createElement(material.Grid, { container: true, spacing: 2, alignItems: "center", justifyContent: "center" },
                        showPlaceholderImage && (React.createElement(material.Grid, __assign({ item: true, xs: 12, sm: 3, md: 4, sx: { textAlign: 'center', mt: { xs: -3, sm: 2 } } }, PlaceholderGridProps),
                        ...
                        React.createElement(material.Grid, __assign({ item: true, xs: 12, sm: true, md: true, sx: {
                            ...
                            React.createElement(material.Typography, { variant: "caption" },
                                leftLabel,
                                React.createElement(material.Button, { size: "small", color: "secondary", variant: "outlined", onClick: function () {
                                        var _a;
                                        if (disabled)
                                            return;
                ...
                error && (React.createElement(material.Alert, { color: "error", severity: "error", sx: { mt: 1 }, onClose: function () { return setError(null); } }, error)),
                (files === null || files === void 0 ? void 0 : files.length) > 0 && (React.createElement(React.Fragment, null,
                    ...
                    , { 
                        ...
                        return (React.createElement(FileAttachment, { file: file, size: size, index: index, key: "upload-file--".concat(index), handleRemoveFile: removeFile }));
                    })),
                    React.createElement(material.Typography, { component: "div", align: "right", sx: { mt: 1 } },
                        React.createElement(material.Button, { size: "small", onClick: removeFile, ref: buttonDeleteRef }, buttonRemoveLabel || 'Remove all')))))));
    }
